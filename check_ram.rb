...
available       = `/opt/puppetlabs/puppet/bin/facter memory.system.available`.strip!
available_bytes = `/opt/puppetlabs/puppet/bin/facter memory.system.available_bytes`.strip!
used            = `/opt/puppetlabs/puppet/bin/facter memory.system.used`.strip!
used_bytes      = `/opt/puppetlabs/puppet/bin/facter memory.system.used_bytes`.strip!
total           = `/opt/puppetlabs/puppet/bin/facter memory.system.total`.strip!
total_bytes     = `/opt/puppetlabs/puppet/bin/facter memory.system.total_bytes`.strip!
