...
used_perc      = ((facter['memory.swap']['used_bytes'].to_f / facter['memory.swap']['total_bytes'].to_f) * 100).round(2)
available_perc = ((facter['memory.swap']['available_bytes'].to_f / facter['memory.swap']['total_bytes'].to_f) * 100).round(2)
